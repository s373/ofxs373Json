...
#  define JSONBOX_DEPRECATED_EXPORT JSONBOX_EXPORT __attribute__ ((__deprecated__))
#  define JSONBOX_DEPRECATED_NO_EXPORT JSONBOX_NO_EXPORT __attribute__ ((__deprecated__))
#endif
