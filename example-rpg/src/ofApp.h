...
class ofApp : public ofBaseApp{
	...
	public:
		...
		void setup(){
			...
			string dirstr=ofToDataPath("./");
			cout << "dirstr "<< dirstr << endl;

			// Load the entities
			entityManager.loadJson<Item>(dirstr+"items.json");
			entityManager.loadJson<Weapon>(dirstr+"weapons.json");
			entityManager.loadJson<Armor>(dirstr+"armor.json");
			entityManager.loadJson<Creature>(dirstr+"creatures.json");
			entityManager.loadJson<Door>(dirstr+"doors.json");
			entityManager.loadJson<Area>(dirstr+"areas.json");
